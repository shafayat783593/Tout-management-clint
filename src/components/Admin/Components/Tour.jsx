...
const TourForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        newtravels.departureDate = departureDate;

        axiosSecure.post("/addTourPackages", newtravels)
            .then(function (response) {
                ...
                Swal.fire({
                    position: "center",
                    icon: "success",
                    title: "Tour package created successfully!",
            ...
            .catch(function (error) {
                ...
                Swal.fire({
                    position: "center",
                    icon: "error",
                    title: "Failed to create tour package",
                    showConfirmButton: false,
                    timer: 1500
                });
            });
            ...
            >
                ...
                <form ref={formRef} onSubmit={handleSubmit}>
                    <motion.div className="grid grid-cols-1 md:grid-cols-2 gap-6" variants={containerVariants}>
                        ...
                        <motion.div variants={itemVariants}>
                            <label className="block text-sm font-medium mb-1 flex items-center">
                                <MdAddPhotoAlternate className="mr-2" /> Tour Photo URL
                            </label>
                            <input
                                type="url"
                                name="photo"
                        ...
                        <motion.div variants={itemVariants}>
                            ...
                            <input
                                ...
                                type="text"
                                name="guidName"
                                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-gray-100"
                            />
                        </motion.div>
                        ...
                        <motion.div variants={itemVariants}>
                            <label className="block text-sm font-medium mb-1 flex items-center">
                                <MdAddPhotoAlternate className="mr-2" /> Guide Photo URL
                            </label>
                            <input
