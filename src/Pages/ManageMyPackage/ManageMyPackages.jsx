...
//         axiosSecure(`
https://tour-management-server-ashen.vercel.app/manageMyPackages/${user.email}`).then(res => {
...
//                 axios.delete(`
https://tour-management-server-ashen.vercel.app/deleteMyPost/${id}`).then(res => {
